                            ...
                            <div className="iq-email-to-list p-3">
                                <div className="d-flex justify-content-between">
                                    <ul className="list-inline d-flex align-items-center justify-content-between m-0 p-0">
                                        <li className="me-3">
                                            <Link to="#" className="email-remove" onClick={() =>{props.onclick(false)}} >
                                                <i className="ri-arrow-left-line m-0 h4" ></i>
                                            </Link>
                                        </li>
                                        <li className="me-2"><OverlayTrigger placement="top" overlay={<Tooltip>Mail</Tooltip>} className="me-1"><Link to="#"><i className="ri-mail-open-line"></i></Link></OverlayTrigger></li>
                                        <li className="me-2"><OverlayTrigger placement="top" overlay={<Tooltip>Info</Tooltip>} className="me-1"><Link to="#"><i className="ri-information-line"></i></Link></OverlayTrigger></li>
                                        <li className="me-2"><OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>} className="me-1"><Link to="#"><i className="ri-delete-bin-line"></i></Link></OverlayTrigger></li>
                                        <li className="me-2"><OverlayTrigger placement="top" overlay={<Tooltip>Unread</Tooltip>} className="me-1"><Link to="#"><i className="ri-mail-unread-line"></i></Link></OverlayTrigger></li>
                                        <li className="me-2"><OverlayTrigger placement="top" overlay={<Tooltip>Transfer</Tooltip>} className="me-1"><Link to="#"><i className="ri-folder-transfer-line"></i></Link></OverlayTrigger></li>
                                        <li className="me-2"><OverlayTrigger placement="top" overlay={<Tooltip>Bookmark</Tooltip>} className="me-1"><Link to="#"><i className="ri-bookmark-line"></i></Link></OverlayTrigger></li>
                                    </ul>
                                ...
                                <div className="iq-inbox-subject-info">
                                    <div className="iq-subject-info">
                                        ...
                                        <div className="iq-subject-status align-self-center">
                                            <h6 className="mb-0">ElectNow team <Link to="dummy@ElectNow.com">dummy@ElectNow.com</Link></h6>
